                    ...
                    <div className="fixed inset-0 z-[10000] md:hidden">
                        ...
                        >
                            ...
                            <div className="flex flex-col">
                                {[
                                    { name: "Home", path: "/" },
                                    { name: "Shop Poha", path: "/shop", hasSub: true, subItems: ["Combos", "Single Packs", "Jeeravan Spices"] },
                                    { name: "Sugar Care Tea", path: "/sugar-care-tea" },
                ...
                <div className="grid grid-cols-3 items-center px-4 md:px-12 py-3 md:py-4 w-full max-w-screen-2xl mx-auto">
                    ...
                    <div className="flex items-center justify-start gap-4">
                        ...
                        <div className="hidden md:flex items-center gap-8">
                            ...
                            <Link className="text-stone-900 dark:text-stone-100 font-bold tracking-tight hover:text-primary transition-colors text-sm uppercase" to="/shop">Shop Poha</Link>
                            <Link className="text-[#0b3a24] dark:text-[#82db7e] font-black tracking-tight hover:text-primary transition-colors text-sm uppercase" to="/sugar-care-tea">Sugar Care Tea</Link>
