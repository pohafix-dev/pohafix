...
const Privacy = () => {
    ...
    return (
        <div className="bg-surface min-h-screen text-on-surface font-body selection:bg-secondary-container selection:text-on-secondary-container">
            <Helmet>
                <title>Privacy Policy | PohaFix</title>
                <meta name="description" content="Read the Privacy Policy of PohaFix. Learn how we collect, use, and protect your personal information." />
            </Helmet>
            <Header />
