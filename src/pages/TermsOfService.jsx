...
const TermsOfService = () => {
    ...
    return (
        <div className="bg-surface min-h-screen text-on-surface font-body selection:bg-secondary-container selection:text-on-secondary-container">
            <Helmet>
                <title>Terms of Service | PohaFix</title>
                <meta name="description" content="Read the Terms of Service for PohaFix. By using our website and purchasing our products, you agree to these terms and conditions." />
            </Helmet>
            <Header />
