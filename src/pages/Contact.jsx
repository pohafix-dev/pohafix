...
const Contact = () => {
    ...
    return (
        <div className="bg-surface min-h-screen text-on-surface font-body selection:bg-primary-container selection:text-on-primary-container">
            <Helmet>
                <title>Contact Us | PohaFix Support</title>
                <meta name="description" content="Get in touch with the PohaFix team for support, bulk orders, or any inquiries about our authentic Indori Poha." />
            </Helmet>
            <Header />
