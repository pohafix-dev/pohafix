...
const RefundPolicy = () => {
    ...
    return (
        <div className="bg-surface min-h-screen text-on-surface font-body selection:bg-secondary-container selection:text-on-secondary-container">
            <Helmet>
                <title>Refund & Return Policy | PohaFix</title>
                <meta name="description" content="View the PohaFix refund and return policy. We ensure your satisfaction with our instant Indori Poha." />
            </Helmet>
            <Header />
