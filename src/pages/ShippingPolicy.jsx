...
const ShippingPolicy = () => {
    ...
    return (
        <div className="bg-surface min-h-screen text-on-surface font-body selection:bg-secondary-container selection:text-on-secondary-container">
            <Helmet>
                <title>Shipping Policy | PohaFix Delivery</title>
                <meta name="description" content="Learn about PohaFix shipping rates, delivery times, and order processing. We offer free shipping across India for our authentic Indori Poha." />
            </Helmet>
            <Header />
